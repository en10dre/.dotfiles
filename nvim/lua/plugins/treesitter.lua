        ...
        config = function()
            require 'nvim-treesitter.configs'.setup {
                ...
                ensure_installed = { "c", "lua", "vim", "vimdoc", "query",
                    "markdown", "markdown_inline", "norg", "gleam", "perl",
                    "scala", "python", "latex", "html", "css", "javascript" },
                ...
                highlight = {
                    ...
                    -- filetype. (for example if you want to disable
                    -- highlighting for the `tex` filetype, you need to include
                    -- `latex` in this list as this is the name of the parser)
                    -- list of language that will be disabled
                    disable = {},
                    -- Or use a function for more flexibility, e.g. to disable
                    -- slow treesitter highlight for large files
